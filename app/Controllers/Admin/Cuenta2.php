...
class Cuenta2 extends BaseController
{
    private $db = "";
    private $table = "cuenta2";
    private $nombre = "cuenta2";
    private $lista = "cuenta2";
    private $dataView = [];
    private $model = "";
    ...
    public function agregar(){
        ...
        if ($this->request->getPost('submit')) {
            $rules = [
                'codigo' => 'required|validateCodigoCuenta2',
                'descripcion' => 'required',
            ];

            $errors = [
                'codigo' => [
                    'validateCodigoCuenta2' => 'Este código ya está registrado'
                ]
            ];
    ...
    public function ajaxGetCuenta2(){
        $cuentas = (new Cuenta2Model())->where("idCuenta",$this->request->getVar('idCuenta'))->where("estado","1")->findAll();
    ...
    public function editar($id){
        ...
        if ($this->request->getPost('submit')) {
            ...
            if($f_model["codigo"] == $this->request->getVar('codigo'))
                ...
                $rules["codigo"] = 'required|validateCodigoCuenta2';
