...
<a class="btn btn-success mb-4 text-white" href="admin/rendicion/agregar"><i class="bi bi-plus-lg"></i> Rendición</a>
    ...
    <tbody>
        ...
        <td>
            <div class="input-group">
                ...
                <a target="_blank" data-bs-toggle="tooltip" data-bs-placement="top" title="Ver Detalles de la orden" elId="<?= $value->id ?>" href="admin/rendicion/ver/<?= $value->id ?>" class="text-white btn btn-info btn-sm"><i class="bi bi-eye"></i></a>
