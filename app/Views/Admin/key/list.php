...
<p>
    <a href="admin/<?= $lista ?>/agregar" class="btn btn-warning"><i class="bi bi-plus-lg"></i> Agregar Key</a>
</p>
    ...
    <?php foreach ($lista_datos as $key => $value) : ?>
        <tr> 
            ...
            <td>
                ...
                <a href="admin/<?= $table ?>/centro/<?= $value->id ?>" class="btn btn-success"><i class="bi bi-card-checklist"></i> Centro de costo</a>
