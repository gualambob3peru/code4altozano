<div class="container">
    ...
    <form action="" method="POST">
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" name="nombres" class="form-control" id="nombres" value="<?= $f_model["nombres"] ?>" required>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" name="apellidoPaterno" class="form-control" id="apellidoPaterno" value="<?= $f_model["apellidoPaterno"] ?>" required>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" name="apellidoMaterno" class="form-control" id="apellidoMaterno" value="<?= $f_model["apellidoMaterno"] ?>" required>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                ...
                <?php foreach($tipoDocumentos as $key=>$value): ?>
                    <option <?php echo (($value->id == $f_model["idTipoDocumento"])?"selected":"") ?> value="<?= $value->id ?>"><?= $value->descripcion ?></option>
                <?php endforeach; ?>
                </select>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" name="nroDocumento" class="form-control" id="nroDocumento" value="<?= $f_model["nroDocumento"] ?>" required>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                ...
                <?php foreach($cargos as $key=>$value): ?>
                    <option <?php echo (($value->id == $f_model["idCargo"])?"selected":"") ?> value="<?= $value->id ?>"><?= $value->descripcion ?></option>
                <?php endforeach; ?>
                </select>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="email" name="email" class="form-control" id="email" value="<?= $f_model["email"] ?>" required>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="telefono" name="telefono" class="form-control" id="telefono" value="<?= $f_model["telefono"] ?>">
