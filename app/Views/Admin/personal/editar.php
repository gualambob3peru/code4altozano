<div class="container">
    ...
    <form action="" method="POST">
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" name="nombres" class="form-control" id="nombres" value="<?= $f_model["nombres"] ?>">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" name="apellidoPaterno" class="form-control" id="apellidoPaterno" value="<?= $f_model["apellidoPaterno"] ?>">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" name="apellidoMaterno" class="form-control" id="apellidoMaterno" value="<?= $f_model["apellidoMaterno"] ?>">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" name="nroDocumento" class="form-control" id="nroDocumento" value="<?= $f_model["nroDocumento"] ?>">
